...
impl Img {
	fn new() -> Self {
		...
		let mut vec = vec![
				("さよーならあなた", egui_extras::RetainedImage::from_image_bytes("a.png", include_bytes!("../../assets/images/art/unknown.png")).unwrap()),
				("ひかれあい", egui_extras::RetainedImage::from_image_bytes("b.png", include_bytes!("../../assets/images/art/unknown.png")).unwrap()),
				("祝祭", egui_extras::RetainedImage::from_image_bytes("c.png", include_bytes!("../../assets/images/art/unknown.png")).unwrap()),
				("祝祭ひとりでに", egui_extras::RetainedImage::from_image_bytes("d.png", include_bytes!("../../assets/images/art/unknown.png")).unwrap()),
				("燦々", egui_extras::RetainedImage::from_image_bytes("e.png", include_bytes!("../../assets/images/art/unknown.png")).unwrap()),
				("燦々ひとりでに", egui_extras::RetainedImage::from_image_bytes("f.png", include_bytes!("../../assets/images/art/unknown.png")).unwrap()),
				("よすが", egui_extras::RetainedImage::from_image_bytes("g.png", include_bytes!("../../assets/images/art/unknown.png")).unwrap()),
				("よすがひとりでに", egui_extras::RetainedImage::from_image_bytes("h.png", include_bytes!("../../assets/images/art/unknown.png")).unwrap()),
				("タオルケットは穏やかな", egui_extras::RetainedImage::from_image_bytes("i.png", include_bytes!("../../assets/images/art/unknown.png")).unwrap()),
		];
		Self {
			vec,
		}
