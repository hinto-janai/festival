...
# Update icon/binary.
rm "${APP_DIR}/256.png"
rm "${APP_DIR}/usr/bin/festival"
cp ../images/icon/256.png "${APP_DIR}/256.png"
cp ../target/release/festival "${APP_DIR}/usr/bin/festival"
...
# Wipe icon/binary.
echo > "${APP_DIR}/256.png"
echo > "${APP_DIR}/usr/bin/festival"
