...
pub static THREADS: Lazy<usize> = Lazy::new(|| match std::thread::available_parallelism() {
    Ok(t) => t.get(),
    Err(_) => 1,
});
...
///
/// This is lazily evaluated and returns 1 on errors.
pub static THREADS_25: Lazy<usize> = Lazy::new(|| match *THREADS {
    0 | 1 | 2 | 3 | 4 => 1,
...
///
/// This is lazily evaluated and returns 1 on errors.
pub static THREADS_50: Lazy<usize> = Lazy::new(|| match *THREADS {
    0 | 1 | 2 => 1,
...
///
/// This is lazily evaluated and returns 1 on errors.
pub static THREADS_75: Lazy<usize> = Lazy::new(|| match *THREADS {
    0 | 1 | 2 => 1,
    3 => 2,
    4 => 3,
...
///
/// This is lazily evaluated and returns 1 on errors.
pub static THREADS_90: Lazy<usize> = Lazy::new(|| match *THREADS {
    0 | 1 | 2 => 1,
    3 => 2,
    4 => 3,
