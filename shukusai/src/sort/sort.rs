...
pub const SONG_ALBUM_RELEASE_ARTIST_LEXI: &str =
    "Artists A-Z, albums oldest-latest, songs in track order";
/// [`SongSort::AlbumReleaseArtistLexiRev`]
pub const SONG_ALBUM_RELEASE_ARTIST_LEXI_REV: &str =
    "Artists Z-A, albums oldest-latest, songs in track order";
/// [`SongSort::AlbumReleaseRevArtistLexi`]
pub const SONG_ALBUM_RELEASE_REV_ARTIST_LEXI: &str =
    "Artists A-Z, albums latest-oldest, songs in track order";
/// [`SongSort::AlbumReleaseRevArtistLexiRev`]
pub const SONG_ALBUM_RELEASE_REV_ARTIST_LEXI_REV: &str =
    "Artists Z-A, albums latest-oldest, songs in track order";
...
/// [`SongSort::AlbumLexiArtistLexiRev`]
pub const SONG_ALBUM_LEXI_REV_ARTIST_LEXI_REV: &str =
    "Artists Z-A, albums Z-A, songs in track order";
