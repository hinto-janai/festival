...
pub(crate) const ALBUM_ART_SIZE: usize = 500;
...
pub(crate) const UNKNOWN_ALBUM_BYTES: &[u8] =
    include_bytes!("../../../../assets/images/art/unknown.png");
pub(crate) static UNKNOWN_ALBUM: Lazy<RetainedImage> =
    Lazy::new(|| RetainedImage::from_image_bytes("Unknown", UNKNOWN_ALBUM_BYTES).unwrap());
...
impl bincode::Decode for Art {
    fn decode<D: bincode::de::Decoder>(
        ...
        match variant_index {
            1u32 => Ok(Self::Bytes(bincode::Decode::decode(decoder)?)),
            _ => Ok(Self::Unknown),
        }
    }
}
impl<'de> bincode::BorrowDecode<'de> for Art {
    fn borrow_decode<D: bincode::de::BorrowDecoder<'de>>(
        ...
        let variant_index = <u32 as bincode::Decode>::decode(decoder)?;
        match variant_index {
            1u32 => Ok(Self::Bytes(bincode::BorrowDecode::borrow_decode(decoder)?)),
            _ => Ok(Self::Unknown),
        }
    }
}
