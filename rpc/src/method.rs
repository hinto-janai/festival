...
pub enum Rpc {
	...
	DaemonConfig(crate::param::DaemonConfig),
	...
	DaemonSeenIps(crate::param::DaemonSeenIps),
	DaemonShutdown(crate::param::DaemonShutdown),
	DaemonState(crate::param::DaemonState),
	...
	PlaylistGetIndex(crate::param::PlaylistGetIndexOwned),
	PlaylistRemoveIndex(crate::param::PlaylistRemoveIndexOwned),
	PlaylistAddKeyArtist(crate::param::PlaylistAddKeyArtistOwned),
	PlaylistAddKeyAlbum(crate::param::PlaylistAddKeyAlbumOwned),
	PlaylistAddKeySong(crate::param::PlaylistAddKeySongOwned),
