...
curl http://localhost:18425 -d '{"jsonrpc":"2.0","id":0,"method":"add_queue_key_artist","params":{"key":123,"append":"back","clear":false}}'
```

#### Example Request 2
```bash
# Append at queue index 4.
curl http://localhost:18425 -d '{"jsonrpc":"2.0","id":0,"method":"add_queue_key_artist","params":{"key":123,"append":"index","index":4,"clear":false}}'
```
